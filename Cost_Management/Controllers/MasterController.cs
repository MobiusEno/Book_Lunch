...
namespace Cost_Management.Controllers
{
    public class MasterController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Master(string formID, string formName, string formNumber,string RequireNumber, float circleID, string description, string nation, string exp_date
